...
OdomRTABMAP::OdomRTABMAP() : rclcpp::Node("rtabmap_tf_publisher") {
    ...
    this->declare_parameter<bool>("use_rtabmap", true);
...
void OdomRTABMAP::odom_px4_publisher() {
        ...
        _px4_quat = utilities::rot2quat( _R_t265toNed*utilities::Q2R( _t265_quat ) );
        ...
        odom_px4->q[0] = _px4_quat[0];
        odom_px4->q[1] = _px4_quat[1];
        odom_px4->q[2] = _px4_quat[2];
        odom_px4->q[3] = _px4_quat[3];
        odom_px4->velocity_frame = 3;
